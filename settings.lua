...
local translations = {
	["English"] = {
		...
		session_exp_on_level_up_d = "What to do on level up",
		...
		nerf = "Nerf",
		nerf_statue = "Statue",
		nerf_statue_d = "Statues won't grant experience",
		reset_cat = "Reset",
	...
	["русский"] = {
		...
		session_exp_on_level_up_d = "При поднятии уровня",
		...
		nerf = "Нерфы",
		nerf_statue = "Статуя",
		nerf_statue_d = "Статуи не будут давать опыта",
		reset_cat = "Сброс",
	...
	["Deutsch"] = {
		...
		use_stash_hotkey = "Abgelegte Belo.",
		use_stash_hotkey_d = "Taste um abgelegte Belohnung zu nutzen",
		...
		session_exp_on_level_up_d = "Was passiert bei Stufenaufstieg",
		...
		session_exp_log = "Erfahrung und Name anzeigen",
		...
		nerf = "Anpassungen",
		nerf_statue = "Statue",
		nerf_statue_d = "Statuen gewähren keine Erfahrung.",
