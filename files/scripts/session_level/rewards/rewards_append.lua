...
if ModIsEnabled("meta_leveling") then
  ModLuaFileAppend("mods/meta_leveling/files/scripts/session_level/rewards/rewards_append.lua", "mods/meta_leveling/files/scripts/session_level/rewards/add_reward_example.lua")
end
